...
class Assessor::AssignmentsControllerTest < ActionController::TestCase
  def test_index
    get :index
  ...
  def test_create_valid
    ...
    post :create
    assert_redirected_to assessor_assignment_url(assigns(:assignment))
  end
  ...
  def test_destroy
    ...
    assert_redirected_to assessor_assignments_url
