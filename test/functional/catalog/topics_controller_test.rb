...
class Catalog::TopicsControllerTest < ActionController::TestCase
  def test_index
    get :index
  ...
  def test_create_valid
    ...
    post :create
    assert_redirected_to catalog_topic_url(assigns(:topic))
  end
  ...
  def test_destroy
    ...
    assert_redirected_to catalog_topics_url
