...
class Catalog::QuestionsControllerTest < ActionController::TestCase
  def test_index
    get :index
  ...
  def test_create_valid
    ...
    post :create
    assert_redirected_to catalog_question_url(assigns(:question))
  end
  ...
  def test_destroy
    ...
    assert_redirected_to catalog_questions_url
